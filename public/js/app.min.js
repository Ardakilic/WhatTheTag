...
function readURL(t){if(t.files&&t.files[0]){var a=new FileReader;a.onload=function(t){$("#previewGrp").removeClass("hide"),$("#previewImg").attr("src",t.target.result)},a.readAsDataURL(t.files[0])}}function triggerTooltip(){$('img[data-toggle="tooltip"]').tooltip()}$("[rel='tooltip']").tooltip(),$(".list-thumbnail").hover(function(){$(this).find(".list-caption").slideDown(250)},function(){$(this).find(".list-caption").slideUp(250)}),$('a[data-link-type="list-modal"]').click(function(){$("#myModal #myModalTitle").text($(this).attr("data-img-title")),$("#myModal img").attr("src",$(this).attr("data-img-url")),$("#myModal #modalDownloadBtn").attr("href",$(this).attr("data-img-url")),$("#myModal #modalTagWrapper").html("<h4>"+$(this).closest(".caption").find(".tagsWrapper").html()+"<h4>")}),$.fn.dataTableExt.sErrMode="throw",$('input[name="photo"]').change(function(){readURL(this)}),$(document).on("click",".delete-button",function(){return confirm("Are you sure you want to delete this photo?")}),$('div[data-group="share-buttons"] input[type="text"]').click(function(){$(this).focus().select()}),$(document).on("click",'a[data-modal-type="admin-modal"]',function(){$("#myModal #myModalTitle").text($(this).attr("data-img-title")),$("#myModal img").attr("src",$(this).attr("data-img-url")),$("#myModal #modalDownloadBtn").attr("href",$(this).attr("data-img-url"))}),$("#admin-photos-table").on("order.dt",function(){triggerTooltip()}).on("search.dt",function(){triggerTooltip()}).on("page.dt",function(){triggerTooltip()}).DataTable({processing:!0,serverSide:!0,ajax:$("#admin-photos-table").attr("data-source"),columns:[{data:"id"},{data:"image",orderable:!1,searchable:!1},{data:"title"},{data:"name"},{data:"created_at"},{data:"updated_at"},{data:"action",name:"action",orderable:!1,searchable:!1}],fnInitComplete:function(){triggerTooltip()}}),$("#admin-users-table").DataTable({processing:!0,serverSide:!0,ajax:$("#admin-users-table").attr("data-source"),columns:[{data:"id",name:"id"},{data:"name",name:"name"},{data:"email",name:"email"},{data:"role",name:"role"},{data:"created_at",name:"created_at"},{data:"updated_at",name:"updated_at"},{data:"action",name:"action",orderable:!1,searchable:!1}]});