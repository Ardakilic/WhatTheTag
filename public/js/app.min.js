...
$("[rel='tooltip']").s();$(".list-thumbnail").i(function(){$(this).find(".list-caption").m(250)},function(){$(this).find(".list-caption").o(250)});$('a[data-link-type="list-modal"]').click(function(){$("#myModal #myModalTitle").text($(this).a("data-img-title"));$("#myModal img").a("src",$(this).a("data-img-url"));$("#myModal #modalDownloadBtn").a("href",$(this).a("data-img-url"));$("#myModal #modalTagWrapper").b("<h4>"+$(this).c(".caption").find(".tagsWrapper").b()+"<h4>")});$.h.f.l="throw";
$(document).j("click",".delete-button",function(){return confirm("Are you sure you want to delete this photo?")});$(".dropify").g();
$(document).b("click",'a[data-modal-type="admin-modal"]',function(){$("#myModal #myModalTitle").text($(this).a("data-img-title"));$("#myModal img").a("src",$(this).a("data-img-url"));$("#myModal #modalDownloadBtn").a("href",$(this).a("data-img-url"))});function a(){$('img[data-toggle="tooltip"]').o()}
$("#admin-photos-table").b("order.dt",function(){a()}).b("search.dt",function(){a()}).b("page.dt",function(){a()}).g({l:!0,m:!0,h:$("#admin-photos-table").a("data-source"),i:[{data:"id"},{data:"image",c:!1,f:!1},{data:"title"},{data:"name"},{data:"created_at"},{data:"updated_at"},{data:"action",name:"action",c:!1,f:!1}],j:function(){a()}});
$("#admin-users-table").a({h:!0,j:!0,b:$("#admin-users-table").c("data-source"),f:[{data:"id",name:"id"},{data:"name",name:"name"},{data:"email",name:"email"},{data:"role",name:"role"},{data:"created_at",name:"created_at"},{data:"updated_at",name:"updated_at"},{data:"action",name:"action",g:!1,i:!1}]});
$('div[data-group="share-buttons"] input[type="text"]').click(function(){$(this).focus().select()});
