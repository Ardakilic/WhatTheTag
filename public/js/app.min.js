...
!function(a){a.fn.socialShare=function(b){function c(a){if(b.toWord){if(a>=1e9)return(a/1e9).toFixed(1)+"G";if(a>=1e6)return(a/1e6).toFixed(1)+"M";if(a>=1e3)return(a/1e3).toFixed(1)+"K"}return a}var d={url:window.location.href,description:a("meta[name=description]").attr("content"),title:a("title").text(),counts:!0,twitter:!0,facebook:!0,pinterest:!0,linkedIn:!0,gPlus:!0,image:null,toWord:!0,twitterVia:null,twitterHashTags:null},e=this;return b=jQuery.extend({},d,b),this.each(function(){function d(d){b.facebook&&(b.counts&&e.find(".facebook-count").each(function(){a(this).html(c(d.facebook))}),e.find(".facebook-share").each(function(){var c="https://facebook.com/sharer/sharer.php?u="+encodeURIComponent(b.url);a(this).click(function(){f(c,"facebook")})})),b.twitter&&(b.counts&&e.find(".twitter-count").each(function(){a(this).html(c(d.twitter))}),e.find(".twitter-share").each(function(){var c="https://twitter.com/share?url="+b.url+"&text="+b.description+"&via="+b.twitterVia+"&hashtags="+b.twitterHashTags;a(this).click(function(){f(c,"twitter")})})),b.pinterest&&(b.counts&&e.find(".pinterest-count").each(function(){a(this).html(c(d.pinterest))}),e.find(".pinterest-share").each(function(){var c="https://pinterest.com/pin/create/bookmarklet/?media="+b.image+"&url="+b.url+"&description="+b.description;a(this).click(function(){f(c,"pinterest")})})),b.linkedIn&&(b.counts&&e.find(".linkedin-count").each(function(){a(this).html(c(d.linkedIn))}),e.find(".linkedin-share").each(function(){var c="http://www.linkedin.com/shareArticle?url="+b.url;a(this).click(function(){f(c,"linkedin")})})),b.gPlus&&(b.counts&&e.find(".gplus-count").each(function(){a(this).html(c(d.gPlus))}),e.find(".gplus-share").each(function(){var c="https://plus.google.com/share?url="+b.url;a(this).click(function(){f(c,"gplus")})}))}function f(a,b){return window.open(a,b+"-share-dialogue","toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width="+i.width+",height="+i.height+",top="+i.top+",left="+i.left),!1}var g={all:{getCount:function(a){var b=jQuery.Deferred(),c={};return jQuery.getJSON("https://count.donreach.com/?url="+encodeURIComponent(a.url)+"&callback=?",function(a){c.url=a.url,c.facebook=a.shares.facebook,c.twitter=a.shares.twitter,c.linkedIn=a.shares.linkedin,c.pinterest=a.shares.pinterest,c.gPlus=a.shares.google,c.success=!0,b.resolve(c)}).fail(function(a,d,e){alert(e),c.success=!1,b.resolve(c)}),b.promise()}},twitter:{getCount:function(a,b){var c=jQuery.Deferred();return jQuery.getJSON("http://cdn.api.twitter.com/1/urls/count.json?url="+a.url+"&callback=?",function(a){b.twitter=a.count,c.resolve(b)}),c.promise()}},facebook:{getCount:function(a,b){var c=jQuery.Deferred();return jQuery.getJSON("https://api.facebook.com/method/links.getStats?format=json&urls="+a.url+"&callback=?",function(a){b.facebook=a[0].total_count,c.resolve(b)}),c.promise()}},pinterest:{getCount:function(a,b){var c=jQuery.Deferred();return jQuery.getJSON("http://api.pinterest.com/v1/urls/count.json?callback=?&url="+a.url,function(a){b.pinterest=a.count,c.resolve(b)}),c.promise()}},linkedIn:{getCount:function(a,b){var c=jQuery.Deferred();return jQuery.getJSON("https://www.linkedin.com/countserv/count/share?format=jsonp&url="+a.url+"&callback=?",function(a){b.linkedIn=a.count,c.resolve(b)}),c.promise()}},gPlus:{getCount:function(a,b){var c=jQuery.Deferred();return jQuery.getJSON("http://anyorigin.com/get?callback=?&url="+encodeURIComponent("https://plusone.google.com/_/+1/fastbutton?url="+a.url),function(a){b.gPlus=parseFloat(a.contents.match(/\{c: [0-9A-Z.]+/)[0].split(" ")[1]),c.resolve(b)}),c.promise()}}},h={};b.counts?g.all.getCount(b).then(function(c){h=c,c.success?d(h):a.when(b.facebook?g.facebook.getCount(b,h):null,b.twitter?g.twitter.getCount(b,h):null,b.pinterest?g.pinterest.getCount(b,h):null,b.linkedIn?g.linkedIn.getCount(b,h):null,b.gPlus?g.gPlus.getCount(b,h):null).then(function(){d(h)})}):d();var i={width:626,height:336,left:a(window).width()/2-313,top:a(window).height()/3-168}})}}(jQuery);
/*!
 * =============================================================
...
function triggerTooltips(){$("[rel='tooltip']").tooltip(),$(".list-thumbnail").hover(function(){$(this).find(".list-caption").slideDown(250)},function(){$(this).find(".list-caption").slideUp(250)}),$('a[data-link-type="list-modal"]').click(function(){$("#myModal #myModalTitle").text($(this).attr("data-img-title")),$("#myModal img").attr("src",$(this).attr("data-img-url")),$("#myModal #modalDownloadBtn").attr("href",$(this).attr("data-img-url")),$("#myModal #modalTagWrapper").html("<h4>"+$(this).closest(".caption").find(".tagsWrapper").html()+"<h4>")})}function triggerTooltip(){$('img[data-toggle="tooltip"]').tooltip()}autocomplete('input[name="q"]',{hint:!0},[{source:autocomplete.sources.hits(index,{hitsPerPage:5}),displayKey:"title",templates:{header:"<h5>Search Results</h5>",suggestion:function(t){return'<div class="picture"><img src="'+t.img_src+'" /></div><span class="name">'+t._highlightResult.title.value+"<span>"},footer:'<div class="branding">Powered by <img src="https://www.algolia.com/assets/algolia128x40.png" style="height:14px;"  /></div>'}}]).on("autocomplete:selected",function(t,a,e){window.location="/photo/detail/"+a.slug}),triggerTooltips(),$.fn.dataTableExt.sErrMode="throw",$(document).on("click",".delete-button",function(){return confirm("Are you sure you want to delete this photo?")}),$(".dropify").dropify(),$('div[data-group="share-buttons"] input[type="text"]').click(function(){$(this).focus().select()}),$(document).on("click",'a[data-modal-type="admin-modal"]',function(){$("#myModal #myModalTitle").text($(this).attr("data-img-title")),$("#myModal img").attr("src",$(this).attr("data-img-url")),$("#myModal #modalDownloadBtn").attr("href",$(this).attr("data-img-url"))}),$("#admin-photos-table").on("order.dt",function(){triggerTooltip()}).on("search.dt",function(){triggerTooltip()}).on("page.dt",function(){triggerTooltip()}).DataTable({processing:!0,serverSide:!0,ajax:$("#admin-photos-table").attr("data-source"),columns:[{name:"photos.id",data:"id"},{data:"image",orderable:!1,searchable:!1},{data:"title"},{data:"name",searchable:!1},{name:"photos.created_at",data:"created_at"},{name:"photos.updated_at",data:"updated_at"},{data:"action",name:"action",orderable:!1,searchable:!1}],fnInitComplete:function(){triggerTooltip()}}),$("#admin-users-table").DataTable({processing:!0,serverSide:!0,ajax:$("#admin-users-table").attr("data-source"),columns:[{data:"id",name:"id"},{data:"name",name:"name"},{data:"email",name:"email"},{data:"role",name:"role"},{data:"created_at",name:"created_at"},{data:"updated_at",name:"updated_at"},{data:"action",name:"action",orderable:!1,searchable:!1}]});